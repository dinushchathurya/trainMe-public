...
urlpatterns = [
    ...
    path('test-async/', views.test_async, name='test_async'),
    path('history/', views.history, name='history'),
    path('compare_videos/',views.compare_videos, name='compare_videos'),
    path('compare_ppts/',views.compare_ppts, name='compare_ppts')
]
